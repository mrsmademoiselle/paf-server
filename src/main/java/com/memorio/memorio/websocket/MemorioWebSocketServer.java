...
import com.memorio.memorio.exceptions.MatchNotFoundException;
...
public class MemorioWebSocketServer extends WebSocketServer {
    ...
    private void handleMessage(WebSocket conn, Map<String, String> jsonMap) {
        ...
        switch (messageKey) {
            case REGISTER_QUEUE:
                System.out.println(LocalTime.now().getMinute() + "neue Verbindung!");
            ...
            default:
                ...
                if (player_default == null)
                    throw new MemorioRuntimeException("Dieser Spieler ist für kein Spiel registriert.");
    ...
    private void verifyAndCreateConnection(WebSocket conn, String jwt) {
        ...
        logger.info("Ist Spieler neu und noch nicht in Queue? " + playerNotYetInMatch);
